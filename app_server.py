...
def render_faq_page() -> None:
    ...
    with st.expander("Quelles sont les limites ?"):
        ...
        changent. Le moteur US calibre ses poids sur quatre recessions NBER seulement ; ce backtest
        penalise maintenant les faux positifs hors recession, mais ne prouve pas la stabilite future
        du modele. Le score combine z-score, drift et momentum par moyenne ponderee afin de limiter
        le biais mecanique d'alerte precoce.
