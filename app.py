...
def render_faq_page() -> None:
    ...
    st.markdown(
        ...
        <div class="faq-grid">
          <div class="faq-card"><strong>Perimetre</strong> Le tableau agrège des series FRED sur credit menages, banques, liquidite, corporate, immobilier, travail, consommation et SLOOS.</div>
            <div class="faq-card"><strong>Score</strong> Les series sont transformees en stress signe. Le moteur combine z-score, drift et momentum par moyenne ponderee, puis penalise les series trop bruyantes hors recession.</div>
    ...
    with st.expander("Comment est construit le score ?"):
        st.markdown(
            ...
            puis combine ces composantes par moyenne ponderee plutot que de retenir le maximum brut.
...
st.markdown(
    ...
    <div class="help-card">
      ...
      moyenne ponderee z-score 5Y, drift pre-COVID et momentum, avec penalite faux positifs hors recession.
